...
# Training Script for Pebbles and Shells
python train.py --epochs 100 --optimizer Adam --lr 0.001 --wd 0 --deterministic \
--compress policies/schedule-pebblesshells.yaml --model ai85cdnet --dataset pebbles_vs_shells \
